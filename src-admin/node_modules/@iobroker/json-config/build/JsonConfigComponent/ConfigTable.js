...
class ConfigTable extends ConfigGeneric {
    ...
    itemTable(attrItem, data, idx) {
        ...
        return (React.createElement(ConfigPanel, { oContext: this.props.oContext, alive: this.props.alive, arrayIndex: idx, changed: this.props.changed, common: this.props.common, expertMode: this.props.expertMode, custom: true, data: data, globalData: this.props.data, index: idx + this.state.iteration, onChange: (attr, valueChange) => {
    ...
    showImportDialog() {
        ...
        return (React.createElement(Dialog, { open: !0, onClose: () => this.setState({ showImportDialog: false }), sx: {
                '& .MuiDialog-paper': {
                    minHeight: 500,
                },
                    ...
                    React.createElement(Paper, { style: styles.paper },
                        React.createElement(Table, null,
                            React.createElement(TableBody, null,
                                ...
                                !schema.noDelete && (React.createElement(TableRow, null,
                                    React.createElement(TableCell, { align: "left", style: tdStyle },

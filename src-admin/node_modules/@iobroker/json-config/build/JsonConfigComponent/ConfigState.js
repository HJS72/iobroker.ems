    ...
    renderItem(_error, disabled /*, defaultValue */) {
        ...
        if (this.state.controlType === 'select' ||
            ...
            if (!text && icon) {
                ...
                content = (React.createElement(Button, { variant: this.props.schema.variant || 'contained', startIcon: icon, style: this.props.schema.falseTextStyle, disabled: disabled || !!this.props.schema.readOnly, onClick: async () => {
                        if (this.props.schema.confirm) {
                            this.setState({
                                confirmDialog: true,
                                confirmCallback: async (result) => {
